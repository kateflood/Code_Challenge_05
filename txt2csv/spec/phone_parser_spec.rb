...
describe Parse do
  ...
  it 'should parse dashes and digits' do
    return_array = @instance.parse_phone('123-456-7890')
  ...
  it 'should parse dashes and country code' do
    return_array = @instance.parse_phone('1-123-456-7890')
  ...
  it 'should parse dots and extension' do
    return_array = @instance.parse_phone('123.456.7890 x1234')
  ...
  it 'should parse dashes and whole enchilada' do
    return_array = @instance.parse_phone('1-123-456-7890 x1234')
